...
-  Check out this guide on more details regarding these parameters:
   :dokuwiki:`resources/fpga/docs/axi_tdd` -- TO EDIT LINK !!!
...
-  SER_PAR_N: defines the interface type:
...
Available configurations and tests combinations
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Build all the possible combinations of tests and configurations, using the Vivado GUI.
This command will launch Vivado, will run the simulation and display the waveforms.
...
The result of the build, if parameters were used, will be in the ``runs`` folder named
...
More info - sa pun HDL user guide; tb user guide
